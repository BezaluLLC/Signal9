    ...
    IAgentService agentService)
{
    ...
    {
        logger.LogInformation("Getting agents with filters");
        ...
        try
        {
            ...
            // Validate parent access (support Guid or Guid?)
        ...
        {
            logger.LogWarning("Validation failed for GetAgents: {Error}", ex.Message);
            return new BadRequestObjectResult(new { error = "Validation failed", details = ex.Message });
        }
        catch (Exception ex)
        {
            logger.LogError(ex, "Error getting agents");
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var agent = await agentService.GetAgentByIdAsync(agentId, includeMetrics, includeTelemetry, cancellationToken);
        ...
        {
            logger.LogError(ex, "Error getting agent {AgentId}", agentId);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var registeredAgent = await agentService.RegisterAgentAsync(agentDto, cancellationToken);
        ...
        {
            logger.LogWarning("Agent registration validation failed: {Error}", ex.Message);
            return new BadRequestObjectResult(new { error = "Registration validation failed", details = ex.Message });
        }
        catch (InvalidOperationException ex)
        {
            logger.LogWarning("Agent registration conflict: {Error}", ex.Message);
            return new ConflictObjectResult(new { error = "Registration conflict", details = ex.Message });
        }
        catch (Exception ex)
        {
            logger.LogError(ex, "Error during agent registration");
    ...
    public async Task<IActionResult> UpdateAgentAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        logger.LogInformation("Updating agent {AgentId}", agentId);
        ...
        try
        {
            ...
            var updatedAgent = await agentService.UpdateAgentAsync(agentId, updateRequest, cancellationToken);
        ...
        {
            logger.LogWarning("Agent update validation failed: {Error}", ex.Message);
            return new BadRequestObjectResult(new { error = "Update validation failed", details = ex.Message });
        }
        catch (Exception ex)
        {
            logger.LogError(ex, "Error updating agent {AgentId}", agentId);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var agent = await agentService.GetAgentByIdAsync(agentId, false, false, cancellationToken);
            ...
            await agentService.DeleteAgentAsync(agentId, preserveData, cancellationToken);
